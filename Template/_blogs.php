        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                    <h5 class="card-title font-size-16">TESLA</h5>
                    <img src="./assets/blog/blog1.jpg" alt="cart image" class="card-img-top">
                    <p class="card-text font-size-14 text-black-50 py-1">ANUARBEK IMANBAEV: "TESLA PLANT IN KAZAKHSTAN IS REAL" <br>
                        Anuarbek Imanbaev is a guy from Kazakhstan who lives in America, Texas. </p>
                    <a href="#" class="color-second text-left">Go somewhere</a>
                </div>
            </div>
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                    <h5 class="card-title font-size-16">Haval Motor Kazakhstan</h5>
                    <img src="./assets/blog/blog2.jpg" alt="cart image" class="card-img-top">
                    <p class="card-text font-size-14 text-black-50 py-1">Haval Motor Kazakhstan is a subsidiary of KMK Astana Motors, which has been present on the Kazakhstan market in the field of sales...</p>
                    <a href="#" class="color-second text-left">Go somewhere</a>
                </div>
            </div>
            <div class="item">
